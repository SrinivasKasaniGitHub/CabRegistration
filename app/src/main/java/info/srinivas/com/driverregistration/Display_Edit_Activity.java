...
public class Display_Edit_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display__edit_);
       ...
       /* if (ServiceHelper.final_response_data.equals("") && ServiceHelper.final_response_data.equals("NA") && ServiceHelper.final_response_data.equals("anyTypse{}")){

            Toast.makeText(getApplicationContext(),"No Data Not Found",Toast.LENGTH_LONG).show();
        }

        Log.i("Welcome", "Display Screen");
        Log.i("Welcome", "" + ServiceHelper.final_response_data);
        txt_dl.setText("" + ServiceHelper.displayres_master[0]);
